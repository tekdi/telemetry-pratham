      ...
      for (const iterator of msgData.events) {
        ...
        promises.push(
          this.connection.query(
            "INSERT INTO ?? (api_id, ver, params, ets, events, channel, pid, mid, syncts) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)",
            [
              table_name,
              msgData.id,
              msgData.ver,
